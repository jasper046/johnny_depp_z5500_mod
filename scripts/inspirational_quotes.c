char *quotes[] = {
   ...
   {"The meaning of life is to find your gift"}, // Anonymous
   ...
   {"Life is not about finding yourself"}, // Lolly Daskal
   {"Nothing in the world is more common than unsuccessful people with talent"}, // Anonymous
   {"Knowledge is being aware of what you can do"}, // Anonymous 
   {"Your problem isn’t the problem"}, // Anonymous
   ...
   {"I don’t want to get to the end of my life and find that I lived just the length of it"}, // Diane Ackerman
   ...
   {"To be successful you must accept all challenges that come your way"}, // Mike Gafka
   {"Success is"}, //  John C. Maxwell
